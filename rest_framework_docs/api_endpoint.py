...
class ApiEndpoint(object):
    ...
    def __init__(self, pattern, parent_pattern=None):
        ...
        self.name_parent = simplify_regex(parent_pattern.namespace).strip('/') if parent_pattern else None
    ...
    def __get_path__(self, parent_pattern):
        if parent_pattern:
            return "/{0}{1}".format(self.name_parent, simplify_regex(self.pattern.__repr__()))
        return simplify_regex(self.pattern.__repr__())
